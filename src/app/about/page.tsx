...
const About = (props: Props) => {
  return (
    <main className="flex flex-col items-center justify-center text-base px-4 h-full">
      <div>
        <div className="mb-4 text-center">
          <p className="text-gray-500 dark:text-gray-400">
            <AnimatedText text="Hi,_`I'm_Satish"/>
          </p>
          <h1 className="text-4xl font-bold dark:text-white">
            <AnimatedText text="About_Me" />
          </h1>
        </div>
        <div className="flex justify-center items-center space-x-4">
          <Image
            ...
            alt="About"
            className="rounded-full aspect-square hidden  lg:block"
            width={450}
            height={200}
          />
          <div className="grid grid-cols-2 gap-4 px-4">
            <div className="border-2 border-gray-400 dark:border-gray-300 rounded-3xl flex flex-col justify-center items-center text-center text-gray-800 dark:text-gray-200 py-4 px-9 col-span-2 md:col-span-1">
              <svg
                className="w-12 h-12 "
                viewBox="0 0 24 24"
                fill="none"
